...
const Skills = () => {
  const techs = [
    ...
    {
      id: 11,
      src: "https://miro.medium.com/v2/resize:fit:383/0*5g3mp6zgIoqprOgV.png",
      title: "Git",
    ...
    {
      id: 15,
      src: "https://ik.imagekit.io/himalayas/https://cdn-images.himalayas.app/kew3msgs6zqrqf0cy27mrxq6mttq?tr=w-256,q-100",
      title: "Postman",
  ...
  return (
    <div
      name="skills"
      className="bg-gradient-to-b from-gray-800 to-black w-full h-screen pt-[32rem] md:pt-[5rem]"
    >
      <div className="max-w-screen-xl mx-auto p-4 flex flex-col justify-center w-full h-full text-white px-2 md:px-12">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-5 gap-8 text-center py-6 px-8 sm:px-0">
          {techs.map(({ id, src, title, style }) => (
            <div
              key={id}
              className={`shadow-md hover:scale-105 duration-500 py-3 md:py-4 rounded-lg ${style} hover:skew-x-6`}
            >
              <img src={src} alt="" className=" w-12 md:w-20 mx-auto" />
              <p className="mt-2 text-sm md:text-lg">{title}</p>
            </div>
          ))}
        </div>
      </div>
